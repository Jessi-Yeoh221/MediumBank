...
export const QR_CODE_DATA = "data:image/png;base64,";

// Official Logo Placeholder (Should be replaced with provided logo asset)
export const LOGO_DATA = "https://images.unsplash.com/photo-1614850523296-d8c1af93d400?auto=format&fit=crop&q=80&w=200";
...
export const ZODIACS: Record<ElementType, ZodiacInfo[]> = {
  [ElementType.FIRE]: [
    { name: '白羊座', element: ElementType.FIRE, keywords: ['行动派', '效率', '跑酷式实验'], description: '细胞，我来了！只要我跑得够快，实验误差就追不上我。', placeholderImg: 'https://images.unsplash.com/photo-1579152276502-5452d53d9e03?auto=format&fit=crop&q=80&w=800' },
    { name: '狮子座', element: ElementType.FIRE, keywords: ['掌控力', '姿势帅', '氛围感'], description: '实验不一定成功，但姿势一定要帅。', placeholderImg: 'https://images.unsplash.com/photo-1576086213369-97a306d36557?auto=format&fit=crop&q=80&w=800' },
    { name: '射手座', element: ElementType.FIRE, keywords: ['探险家', '思想不滑坡', '折腾王'], description: '只要思想不滑坡，实验总有新折腾。', placeholderImg: 'https://images.unsplash.com/photo-1532187875605-1ef638237905?auto=format&fit=crop&q=80&w=800' },
  ],
  [ElementType.EARTH]: [
    { name: '金牛座', element: ElementType.EARTH, keywords: ['大管家', '细胞大餐', '务实'], description: '我可以穷，但我的细胞必须顿顿大餐。', placeholderImg: 'https://images.unsplash.com/photo-1582719508461-905c673771fd?auto=format&fit=crop&q=80&w=800' },
    { name: '处女座', element: ElementType.EARTH, keywords: ['洁癖控', '台面必干净', '完美主义'], description: '主打一个：我做过的实验台面必须干净。', placeholderImg: 'https://images.unsplash.com/photo-1518152006812-edab29b069ac?auto=format&fit=crop&q=80&w=800' },
    { name: '摩羯座', element: ElementType.EARTH, keywords: ['肝帝', '加班狂', '转染专家'], description: '今天不把转染效率提上去，谁也别想下班！', placeholderImg: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?auto=format&fit=crop&q=80&w=800' },
  ],
  [ElementType.AIR]: [
    { name: '双子座', element: ElementType.AIR, keywords: ['情报官', '两个脑子', '多核运作'], description: '我有两个脑子：一个做实验，一个想下班。', placeholderImg: 'https://images.unsplash.com/photo-1507413245164-6160d8298b31?auto=format&fit=crop&q=80&w=800' },
    { name: '天秤座', element: ElementType.AIR, keywords: ['纠结症', '平衡术', '加样纠结'], description: '在加样与不加样之间，我选择了纠结。', placeholderImg: 'https://images.unsplash.com/photo-1530210124550-912dc1381cb8?auto=format&fit=crop&q=80&w=800' },
    { name: '水瓶座', element: ElementType.AIR, keywords: ['脑洞大', '玄学科学', '意念出结果'], description: '科学的尽头是玄学，意念出结果也是结果。', placeholderImg: 'https://images.unsplash.com/photo-1516533075015-a3838414c3ca?auto=format&fit=crop&q=80&w=800' },
  ],
  [ElementType.WATER]: [
    { name: '巨蟹座', element: ElementType.WATER, keywords: ['守护者', '细胞保姆', '治愈系'], description: '别问，问就是在给细胞当保姆。', placeholderImg: 'https://images.unsplash.com/photo-1513128034602-7814ccaddd4e?auto=format&fit=crop&q=80&w=800' },
    { name: '天蝎座', element: ElementType.WATER, keywords: ['洞察力', '细胞掌控者', '高冷'], description: '我的细胞，只听我的话。', placeholderImg: 'https://images.unsplash.com/photo-1576671081837-49000212a370?auto=format&fit=crop&q=80&w=800' },
    { name: '双鱼座', element: ElementType.WATER, keywords: ['梦想家', '星星里的细胞', '感性'], description: '细胞要是能养在星星里就好了。', placeholderImg: 'https://images.unsplash.com/photo-1555543411-7a874e6a41d0?auto=format&fit=crop&q=80&w=800' },
  ]
};
